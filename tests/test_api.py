...
class TestInvoicegeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = InvoicegeneratorAPIClient(self.api_key)

    @patch('apiverve_invoicegenerator.apiClient.requests.get')
